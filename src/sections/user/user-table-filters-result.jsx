...
export function UserTableFiltersResult({ filters, onResetPage, totalResults, sx }) {
  ...
  return (
    <FiltersResult totalResults={totalResults} onReset={handleReset} sx={sx}>
      ...
      <FiltersBlock label="Keyword:" isShow={!!filters.state.fullname}>
        <Chip {...chipProps} label={filters.state.fullname} onDelete={handleRemoveKeyword} />
      </FiltersBlock>
    </FiltersResult>
  );
}
