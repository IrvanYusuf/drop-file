...
import { FloatLine, FloatPlusIcon, FloatTriangleDownIcon } from 'src/components/svg-elements';
...
export function FaqSection({ sx, ...other }) {
    ...
    >
      ...
      <m.div variants={varFade().in}>
        <Button
          color="inherit"
          variant="contained"
          href="mailto:support@dentaloka.com"
